...
const char* cmdline_help[] = {"  -h, --help                 Print help and exit", "  -l, --ll-filename=FILENAME The name of the llvm .ll file containing the function to analyze.",
                              "  -p, --ll-path=PATH         The path to the folder containing the ll file name.", "  -f, --function=STRING      The name of the target function to process", 0};
...
char cmdline_get_opt(int argc, char* argv[], int* option_index)
{
   ...
   static struct options options_list[] = {{"-h", "--help", 0, 'h'}, {"-l", "--ll-filename", 1, 'l'}, {"-p", "--ll-path", 1, 'p'}, {"-f", "--function", 1, 'f'}, {NULL, NULL, 0, '?'}};

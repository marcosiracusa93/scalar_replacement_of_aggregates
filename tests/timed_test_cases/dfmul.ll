...
for.body:                                         ; preds = %for.cond
  ...
  %call3 = call i64 @float64_mul(i64 %5, i64 %6)
  store i64 %call3, i64* %result, align 8
  %7 = load i64, i64* %result, align 8
  %8 = load i32, i32* %i, align 4
  %idxprom4 = sext i32 %8 to i64
  %arrayidx5 = getelementptr inbounds [20 x i64], [20 x i64]* @z_output, i64 0, i64 %idxprom4
  ...
  %arrayidx8 = getelementptr inbounds [20 x i64], [20 x i64]* @a_input, i64 0, i64 %idxprom7
  %12 = load i64, i64* %arrayidx8, align 8
  %13 = load i32, i32* %i, align 4
  %idxprom9 = sext i32 %13 to i64
  %arrayidx10 = getelementptr inbounds [20 x i64], [20 x i64]* @b_input, i64 0, i64 %idxprom9
  %14 = load i64, i64* %arrayidx10, align 8
  %15 = load i32, i32* %i, align 4
  %idxprom11 = sext i32 %15 to i64
  %arrayidx12 = getelementptr inbounds [20 x i64], [20 x i64]* @z_output, i64 0, i64 %idxprom11

...
for.body4:                                        ; preds = %for.cond2
  ...
  %arrayidx5 = getelementptr inbounds [20 x i64], [20 x i64]* @a_input, i64 0, i64 %idxprom
  %6 = load i64, i64* %arrayidx5, align 8
  store i64 %6, i64* %x1, align 8
  %7 = load i32, i32* %i, align 4
  %idxprom6 = sext i32 %7 to i64
  %arrayidx7 = getelementptr inbounds [20 x i64], [20 x i64]* @b_input, i64 0, i64 %idxprom6
  %8 = load i64, i64* %arrayidx7, align 8
  store i64 %8, i64* %x2, align 8
  %9 = load i64, i64* %x1, align 8
  %10 = load i64, i64* %x2, align 8
  %call8 = call i64 @float64_mul(i64 %9, i64 %10)
  store i64 %call8, i64* %result, align 8
  %11 = load i64, i64* %result, align 8
  %12 = load i32, i32* %i, align 4
  %idxprom9 = sext i32 %12 to i64
  %arrayidx10 = getelementptr inbounds [20 x i64], [20 x i64]* @z_output, i64 0, i64 %idxprom9

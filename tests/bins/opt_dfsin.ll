...
__non_const_wrapper__.exit:                       ; preds = %for.body, %csroa.if.end4.i
  ...
  %call.c.i.c = tail call i64 @float64_mul.v0.C.c.c(i64 %.phi.i, i64 %.phi.i) #6
...
do.body.i:                                        ; preds = %do.body.i.backedge, %__non_const_wrapper__.exit
  ...
  %call2.c.i.c = tail call i64 @float64_mul.v0.C.c.c(i64 %diff.0.i, i64 %or.i) #6
...
if.end.i:                                         ; preds = %do.body.i
  ...
  %call4.c.i.c = tail call i64 @packFloat64.v0.C.c.c(i32 %a.lobit.i, i32 %sub3.i, i64 %shl.i) #6
...
int32_to_float64.v0.C.c.exit:                     ; preds = %do.body.i, %if.end.i
  ...
  %call6.c.i.c = tail call i64 @float64_div.v0.C.c.c(i64 %call2.c.i.c, i64 %retval.0.i) #6
  %call.c.i20.c = tail call i32 @extractFloat64Sign.v0.C.c.c(i64 %app.0.i) #6
  %call1.c.i.c = tail call i32 @extractFloat64Sign.v0.C.c.c(i64 %call6.c.i.c) #6
...
if.then.i:                                        ; preds = %int32_to_float64.v0.C.c.exit
  ...
  %call.c.i24.c = tail call i64 @extractFloat64Frac.v0.C.c.c(i64 %app.0.i) #6
  %call1.c.i25.c = tail call i32 @extractFloat64Exp.v0.C.c.c(i64 %app.0.i) #6
  %call2.c.i26.c = tail call i64 @extractFloat64Frac.v0.C.c.c(i64 %call6.c.i.c) #6
  %call3.c.i27.c = tail call i32 @extractFloat64Exp.v0.C.c.c(i64 %call6.c.i.c) #6
...
if.then7.i:                                       ; preds = %if.then6.i
  %call8.c.i.c = tail call fastcc i64 @propagateFloat64NaN.v0.C.c.c(i64 %app.0.i, i64 %call6.c.i.c) #6
...
if.then19.i:                                      ; preds = %if.then17.i
  %call20.c.i.c = tail call fastcc i64 @propagateFloat64NaN.v0.C.c.c(i64 %app.0.i, i64 %call6.c.i.c) #6
  br label %addFloat64Sigs.v0.C.c.exit

if.end21.i:                                       ; preds = %if.then17.i
  %call22.c.i.c = tail call i64 @packFloat64.v0.C.c.c(i32 %call.c.i20.c, i32 2047, i64 0) #6
  br label %addFloat64Sigs.v0.C.c.exit
...
if.then35.i:                                      ; preds = %if.then32.i
  %call36.c.i.c = tail call fastcc i64 @propagateFloat64NaN.v0.C.c.c(i64 %app.0.i, i64 %call6.c.i.c) #6
  br label %addFloat64Sigs.v0.C.c.exit

if.then40.i:                                      ; preds = %if.else30.i
  %add.i36 = add i64 %shl4.i30, %shl.i29
  %shr.i37 = lshr exact i64 %add.i36, 9
  %call41.c.i.c = tail call i64 @packFloat64.v0.C.c.c(i32 %call.c.i20.c, i32 0, i64 %shr.i37) #6
  br label %addFloat64Sigs.v0.C.c.exit
...
roundAndPack.i:                                   ; preds = %if.end46.i, %if.end42.i
  ...
  %call56.c.i.c = tail call fastcc i64 @roundAndPackFloat64.v0.C.c.c(i32 %call.c.i20.c, i32 %zExp.2.i, i64 %zSig.1.i) #6
  br label %addFloat64Sigs.v0.C.c.exit
...
if.else.i:                                        ; preds = %int32_to_float64.v0.C.c.exit
  %call3.c.i.c = tail call fastcc i64 @subFloat64Sigs.v0.C.c.c(i64 %app.0.i, i64 %call6.c.i.c, i32 %call.c.i20.c) #6
  br label %float64_add.v0.C.c.exit
...
float64_add.v0.C.c.exit:                          ; preds = %addFloat64Sigs.v0.C.c.exit, %if.else.i
  ...
  %call.c.i40.c = tail call i32 @extractFloat64Exp.v0.C.c.c(i64 4532020583610935537) #6
...
land.lhs.true.i:                                  ; preds = %float64_add.v0.C.c.exit
  %call1.c.i42.c = tail call i64 @extractFloat64Frac.v0.C.c.c(i64 4532020583610935537) #6
...
lor.lhs.false.i:                                  ; preds = %land.lhs.true.i, %float64_add.v0.C.c.exit
  %call2.c.i44.c = tail call i32 @extractFloat64Exp.v0.C.c.c(i64 %and.i) #6
...
land.lhs.true4.i:                                 ; preds = %lor.lhs.false.i
  %call5.c.i.c = tail call i64 @extractFloat64Frac.v0.C.c.c(i64 %and.i) #6
...
if.then.i45:                                      ; preds = %land.lhs.true4.i, %land.lhs.true.i
  tail call void @float_raise.v0.C.c.c(i32 16) #6
  br label %local_sin.v0.C.c.exit

if.end.i47:                                       ; preds = %land.lhs.true4.i, %lor.lhs.false.i
  %call7.c.i.c = tail call i32 @extractFloat64Sign.v0.C.c.c(i64 4532020583610935537) #6
  %call8.c.i46.c = tail call i32 @extractFloat64Sign.v0.C.c.c(i64 %and.i) #6
...
define internal fastcc i64 @subFloat64Sigs.v0.C.c.c(i64 %a, i64 %b, i32 %zSign) unnamed_addr #4 {
entry:
...
; Function Attrs: noinline norecurse nounwind
define void @shift64RightJamming.v0.C.c.c(i64 %a, i32 %count, i64* nocapture %zPtr) local_unnamed_addr #4 {
entry:
  %cmp = icmp eq i32 %count, 0
...
; Function Attrs: noinline norecurse nounwind
define void @float_raise.v0.C.c.c(i32 %flags) local_unnamed_addr #4 {
entry:
...
; Function Attrs: noinline norecurse nounwind
define internal fastcc i64 @roundAndPackFloat64.v0.C.c.c(i32 %zSign, i32 %zExp, i64 %zSig) unnamed_addr #4 {
entry:
...
; Function Attrs: noinline norecurse nounwind
define internal fastcc i64 @propagateFloat64NaN.v0.C.c.c(i64 %a, i64 %b) unnamed_addr #4 {
entry:
...
; Function Attrs: noinline norecurse nounwind
define i64 @float64_mul.v0.C.c.c(i64 %a, i64 %b) local_unnamed_addr #4 {
entry:
  %call.c.c = tail call i64 @extractFloat64Frac.v0.C.c.c(i64 %a)
  %call1.c.c = tail call i32 @extractFloat64Exp.v0.C.c.c(i64 %a)
...
if.end47:                                         ; preds = %if.then42
  %cmp.i.i1 = icmp ult i64 %call3.c.c, 4294967296
  %shr.i.i2 = lshr i64 %call3.c.c, 32
  %shiftCount.0.i.i3 = select i1 %cmp.i.i1, i32 32, i32 0
  %a.addr.0.i.i4 = select i1 %cmp.i.i1, i64 %call3.c.c, i64 %shr.i.i2
  %conv.i.i5 = trunc i64 %a.addr.0.i.i4 to i32
  %cmp.i1.i6 = icmp ult i32 %conv.i.i5, 65536
  %shl.i.i7 = shl i32 %conv.i.i5, 16
  %..i.i8 = select i1 %cmp.i1.i6, i32 16, i32 0
  %shl.a.i.i9 = select i1 %cmp.i1.i6, i32 %shl.i.i7, i32 %conv.i.i5
  %cmp1.i.i10 = icmp ult i32 %shl.a.i.i9, 16777216
  %add3.i.i11 = or i32 %..i.i8, 8
  %shl4.i.i12 = shl i32 %shl.a.i.i9, 8
  %shiftCount.1.i.i13 = select i1 %cmp1.i.i10, i32 %add3.i.i11, i32 %..i.i8
  %a.addr.1.i.i14 = select i1 %cmp1.i.i10, i32 %shl4.i.i12, i32 %shl.a.i.i9
  %shr.i2.i15 = lshr i32 %a.addr.1.i.i14, 24
  %idxprom.i.i16 = zext i32 %shr.i2.i15 to i64
  %arrayidx.i.i17 = getelementptr inbounds [256 x i32], [256 x i32]* @countLeadingZeros32.countLeadingZerosHigh, i64 0, i64 %idxprom.i.i16
  %1 = load i32, i32* %arrayidx.i.i17, align 4
  %add6.i.i18 = or i32 %shiftCount.1.i.i13, %shiftCount.0.i.i3
  %add1.i.i19 = add i32 %add6.i.i18, %1
  %sub.i20 = add nsw i32 %add1.i.i19, -11
  %sh_prom.i21 = zext i32 %sub.i20 to i64
  %shl.i22 = shl i64 %call3.c.c, %sh_prom.i21
  %sub1.i23 = sub i32 12, %add1.i.i19
  br label %if.end48

if.end48:                                         ; preds = %if.end47, %if.end39
  %2 = phi i32 [ %sub1.i23, %if.end47 ], [ %call4.c.c, %if.end39 ]
  %bSig.0 = phi i64 [ %shl.i22, %if.end47 ], [ %call3.c.c, %if.end39 ]
  %add = add nsw i32 %2, %aExp.0
  %or49 = shl i64 %aSig.0, 10
  %or50 = shl i64 %bSig.0, 11
  %3 = lshr i64 %aSig.0, 22
  %shl = and i64 %3, 3221225471
  %shr.i = or i64 %shl, 1073741824
  %4 = lshr i64 %bSig.0, 21
  %shl51 = and i64 %4, 2147483647
  ...
  %shl.i24 = shl nuw nsw i64 %conv17.i, 32
  %shr18.i = lshr i64 %add.i, 32
  %add19.i = or i64 %shl.i24, %shr18.i
  ...
  %5 = xor i64 %shl56.mask.lobit, 1
  %6 = shl i64 %or55, %5
  %zExp.0.v = select i1 %cmp57, i32 -1024, i32 -1023
  %zExp.0 = add i32 %add, %zExp.0.v
  %call62.c.c = tail call fastcc i64 @roundAndPackFloat64.v0.C.c.c(i32 %xor, i32 %zExp.0, i64 %6)
  br label %return
...
; Function Attrs: noinline norecurse nounwind readnone
define i32 @extractFloat64Sign.v0.C.c.c(i64 %a) local_unnamed_addr #5 {
entry:
  %shr = lshr i64 %a, 63
...
; Function Attrs: noinline norecurse nounwind readnone
define i64 @extractFloat64Frac.v0.C.c.c(i64 %a) local_unnamed_addr #5 {
entry:
...
; Function Attrs: noinline norecurse nounwind readnone
define i32 @extractFloat64Exp.v0.C.c.c(i64 %a) local_unnamed_addr #5 {
entry:
  %shr = lshr i64 %a, 52
...
; Function Attrs: noinline norecurse nounwind
define i64 @float64_div.v0.C.c.c(i64 %a, i64 %b) local_unnamed_addr #4 {
entry:
  %call.c.c = tail call i64 @extractFloat64Frac.v0.C.c.c(i64 %a)
  %call1.c.c = tail call i32 @extractFloat64Exp.v0.C.c.c(i64 %a)
  %call2.c.c = tail call i32 @extractFloat64Sign.v0.C.c.c(i64 %a)
...
if.end34:                                         ; preds = %if.then26
  %cmp.i.i = icmp ult i64 %call3.c.c, 4294967296
  %shr.i.i = lshr i64 %call3.c.c, 32
  %shiftCount.0.i.i = select i1 %cmp.i.i, i32 32, i32 0
  %a.addr.0.i.i = select i1 %cmp.i.i, i64 %call3.c.c, i64 %shr.i.i
  %conv.i.i = trunc i64 %a.addr.0.i.i to i32
  %cmp.i1.i = icmp ult i32 %conv.i.i, 65536
  %shl.i.i = shl i32 %conv.i.i, 16
  %..i.i = select i1 %cmp.i1.i, i32 16, i32 0
...
if.end43:                                         ; preds = %if.then38
  %cmp.i.i5 = icmp ult i64 %call.c.c, 4294967296
  %shr.i.i6 = lshr i64 %call.c.c, 32
  %shiftCount.0.i.i7 = select i1 %cmp.i.i5, i32 32, i32 0
  %a.addr.0.i.i8 = select i1 %cmp.i.i5, i64 %call.c.c, i64 %shr.i.i6
  %conv.i.i9 = trunc i64 %a.addr.0.i.i8 to i32
  %cmp.i1.i10 = icmp ult i32 %conv.i.i9, 65536
  %shl.i.i11 = shl i32 %conv.i.i9, 16
  %..i.i12 = select i1 %cmp.i1.i10, i32 16, i32 0
  %shl.a.i.i13 = select i1 %cmp.i1.i10, i32 %shl.i.i11, i32 %conv.i.i9
  %cmp1.i.i14 = icmp ult i32 %shl.a.i.i13, 16777216
  %add3.i.i15 = or i32 %..i.i12, 8
  %shl4.i.i16 = shl i32 %shl.a.i.i13, 8
  %shiftCount.1.i.i17 = select i1 %cmp1.i.i14, i32 %add3.i.i15, i32 %..i.i12
  %a.addr.1.i.i18 = select i1 %cmp1.i.i14, i32 %shl4.i.i16, i32 %shl.a.i.i13
  %shr.i2.i19 = lshr i32 %a.addr.1.i.i18, 24
  %idxprom.i.i20 = zext i32 %shr.i2.i19 to i64
  ...
  %add6.i.i22 = or i32 %shiftCount.1.i.i17, %shiftCount.0.i.i7
  %add1.i.i23 = add i32 %add6.i.i22, %1
  %sub.i24 = add nsw i32 %add1.i.i23, -11
  %sh_prom.i25 = zext i32 %sub.i24 to i64
  %shl.i26 = shl i64 %call.c.c, %sh_prom.i25
  %sub1.i27 = sub i32 12, %add1.i.i23
  br label %if.end44

if.end44:                                         ; preds = %if.end43, %if.end35
  %2 = phi i32 [ %sub1.i27, %if.end43 ], [ %call1.c.c, %if.end35 ]
  %aSig.0 = phi i64 [ %shl.i26, %if.end43 ], [ %call.c.c, %if.end35 ]
  %sub = sub i32 %2, %bExp.0
  ...
  %cmp.i = icmp ugt i64 %shl47, %aSig.1
  br i1 %cmp.i, label %if.end.i, label %if.end63

if.end.i:                                         ; preds = %if.end44
  %shr.i = lshr i64 %shl47, 32
  %shl.i28 = shl nuw i64 %shr.i, 32
  %cmp1.i = icmp ugt i64 %shl.i28, %aSig.1
  br i1 %cmp1.i, label %cond.false.i, label %cond.end.i

cond.false.i:                                     ; preds = %if.end.i
  %div.i = udiv i64 %aSig.1, %shr.i
...
cond.end.i:                                       ; preds = %cond.false.i, %if.end.i
  ...
  %sub.i31 = sub i64 0, %shl21.i
  %cmp.i33 = icmp ne i64 %shl21.i, 0
  %conv2.neg.i = sext i1 %cmp.i33 to i64
  %add20.i.neg = sub i64 %aSig.1, %mul15.i
  %sub1.i32 = sub i64 %add20.i.neg, %shr18.i
  %sub3.i = add i64 %sub1.i32, %conv2.neg.i
  %cmp31.i = icmp slt i64 %sub3.i, 0
  br i1 %cmp31.i, label %while.body.lr.ph.i, label %while.end.i

while.body.lr.ph.i:                               ; preds = %cond.end.i
  %shl4.i = shl i64 %bSig.0, 43
  br label %while.body.i

while.body.i:                                     ; preds = %while.body.i, %while.body.lr.ph.i
  %3 = phi i64 [ %sub3.i, %while.body.lr.ph.i ], [ %add3.i, %while.body.i ]
  %z.03.i = phi i64 [ %cond.i, %while.body.lr.ph.i ], [ %sub.i29, %while.body.i ]
  %rem1.02.i = phi i64 [ %sub.i31, %while.body.lr.ph.i ], [ %add.i, %while.body.i ]
  %sub.i29 = add i64 %z.03.i, -4294967296
  %add.i = add i64 %rem1.02.i, %shl4.i
  %add1.i = add i64 %3, %shr.i
  %cmp.i34 = icmp ult i64 %add.i, %rem1.02.i
  %conv2.i = zext i1 %cmp.i34 to i64
  %add3.i = add i64 %add1.i, %conv2.i
  %cmp3.i = icmp slt i64 %add3.i, 0
...
while.end.i:                                      ; preds = %while.end.i.loopexit, %cond.end.i
  %rem1.0.lcssa.i = phi i64 [ %sub.i31, %cond.end.i ], [ %add.i, %while.end.i.loopexit ]
  %z.0.lcssa.i = phi i64 [ %cond.i, %cond.end.i ], [ %sub.i29, %while.end.i.loopexit ]
  %.lcssa.i = phi i64 [ %sub3.i, %cond.end.i ], [ %add3.i, %while.end.i.loopexit ]
  %shl5.i = shl i64 %.lcssa.i, 32
  %shr6.i = lshr i64 %rem1.0.lcssa.i, 32
  %or.i = or i64 %shl5.i, %shr6.i
  %cmp8.i = icmp ugt i64 %shl.i28, %or.i
...
if.then56:                                        ; preds = %estimateDiv128To64.v0.C.c.exit
  %shr3.i36 = lshr i64 %or14.i, 32
  %conv6.i = and i64 %or14.i, 4294967295
  %mul.i = mul nuw i64 %conv6.i, %conv5.i
  %mul9.i38 = mul nuw i64 %shr3.i36, %conv5.i
  %mul12.i = mul nuw i64 %conv6.i, %shr.i
  %mul15.i39 = mul nuw i64 %shr3.i36, %shr.i
  %add.i40 = add i64 %mul9.i38, %mul12.i
  %cmp.i41 = icmp ult i64 %add.i40, %mul12.i
  %conv17.i = zext i1 %cmp.i41 to i64
  %shl.i42 = shl nuw nsw i64 %conv17.i, 32
  %shr18.i43 = lshr i64 %add.i40, 32
  %add19.i = or i64 %shl.i42, %shr18.i43
  %shl21.i45 = shl i64 %add.i40, 32
  %add22.i = add i64 %shl21.i45, %mul.i
  %cmp23.i = icmp ult i64 %add22.i, %shl21.i45
  %sub.i46 = sub i64 0, %add22.i
  %conv25.i.neg = sext i1 %cmp23.i to i64
  %cmp.i48 = icmp ne i64 %add22.i, 0
  %conv2.neg.i49 = sext i1 %cmp.i48 to i64
  %add20.i44.neg = sub i64 %aSig.1, %mul15.i39
  %add26.i.neg = sub i64 %add20.i44.neg, %add19.i
  %sub1.i47 = add i64 %add26.i.neg, %conv25.i.neg
  %sub3.i50 = add i64 %sub1.i47, %conv2.neg.i49
  %cmp571 = icmp slt i64 %sub3.i50, 0
...
while.body:                                       ; preds = %while.body.preheader, %while.body
  %4 = phi i64 [ %add3.i54, %while.body ], [ %sub3.i50, %while.body.preheader ]
  %zSig.03 = phi i64 [ %dec, %while.body ], [ %or14.i, %while.body.preheader ]
  %rem1.02 = phi i64 [ %add.i51, %while.body ], [ %sub.i46, %while.body.preheader ]
  %dec = add i64 %zSig.03, -1
  %add.i51 = add i64 %rem1.02, %shl47
  %cmp.i52 = icmp ult i64 %add.i51, %rem1.02
  %conv2.i53 = zext i1 %cmp.i52 to i64
  %add3.i54 = add i64 %conv2.i53, %4
  %cmp57 = icmp slt i64 %add3.i54, 0
...
while.end:                                        ; preds = %while.end.loopexit, %if.then56
  %rem1.0.lcssa = phi i64 [ %sub.i46, %if.then56 ], [ %add.i51, %while.end.loopexit ]

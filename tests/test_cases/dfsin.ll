...
for.body:                                         ; preds = %for.cond
  ...
  %call = call i64 @local_sin(i64 %2)
  store i64 %call, i64* %result, align 8
  %3 = load i64, i64* %result, align 8
  %4 = load i32, i32* %i, align 4
  %idxprom1 = sext i32 %4 to i64
  %arrayidx2 = getelementptr inbounds [36 x i64], [36 x i64]* @test_out, i64 0, i64 %idxprom1
  ...
  %arrayidx5 = getelementptr inbounds [36 x i64], [36 x i64]* @test_in, i64 0, i64 %idxprom4
  %8 = load i64, i64* %arrayidx5, align 8
  %9 = load i32, i32* %i, align 4
  %idxprom6 = sext i32 %9 to i64
  %arrayidx7 = getelementptr inbounds [36 x i64], [36 x i64]* @test_out, i64 0, i64 %idxprom6
  %10 = load i64, i64* %arrayidx7, align 8
  %11 = load i64, i64* %result, align 8
  %12 = load i64, i64* %result, align 8
  %call8 = call double @ullong_to_double(i64 %12)
  %call9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str, i32 0, i32 0), i64 %8, i64 %10, i64 %11, double %call8)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  ...
  %call10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i32 %14)
